...
|-----------------------------------------------------------------------------------------|-------------------------------------|-----------------------------------------------------------------------------|---------------| 
| [`^5` (5.0.0)]([https://github.com/jikan-me/jikan](https://github.com/jikan-me/jikan))  | 🚧 New features - WIP               | [![8.4](https://img.shields.io/badge/PHP-^%208.4-blue.svg?style=flat)]()    | `^11`,`^12`   |
